...
class eventSpikeSender: public yarp::os::BufferedPort< ev::vBottle >
{
...
public:
  ...
  eventSpikeSender(int width, int height, int d_width, int d_height, int polarity, bool flip);
...
class vSpinInterface : public yarp::os::RFModule
{
    ...
    eventSpikeSender  *sender_on_yarp_spikes;
    eventSpikeSender  *sender_off_yarp_spikes;
    ...
    bool initSpin(std::string grabberPortName, int width, int height, int d_width, int d_height, bool flip);
